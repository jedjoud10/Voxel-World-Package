    ...
    struct AttributesMesh
{
    ...
    float3 normalOS : NORMAL;
    float4 tangentOS : TANGENT;
    nointerpolation float4 uv0 : TEXCOORD0;
...
struct VaryingsMeshToPS
{
    ...
    float3 normalWS;
    float4 tangentWS;
    nointerpolation float4 texCoord0;
...
struct SurfaceDescriptionInputs
{
    ...
    nointerpolation float4 uv0;
    nointerpolation float4 VertexColor;
};
struct VertexDescriptionInputs
{
};
struct PackedVaryingsMeshToPS
{
    ...
    nointerpolation float4 interp3 : TEXCOORD3;
    nointerpolation float4 interp4 : TEXCOORD4;
    #if UNITY_ANY_INSTANCING_ENABLED
    uint instanceID : CUSTOM_INSTANCE_ID;
    #endif
};
...
{
    SurfaceDescription surface = (SurfaceDescription)0;
    float4 _UV_d3b9edd36c37449ab8140ec76e38ea65_Out_0 = IN.uv0;
    float _Split_c570f3da0bda46349c834cd412cab5f2_R_1 = _UV_d3b9edd36c37449ab8140ec76e38ea65_Out_0[0];
    float _Split_c570f3da0bda46349c834cd412cab5f2_G_2 = _UV_d3b9edd36c37449ab8140ec76e38ea65_Out_0[1];
    float _Split_c570f3da0bda46349c834cd412cab5f2_B_3 = _UV_d3b9edd36c37449ab8140ec76e38ea65_Out_0[2];
    float _Split_c570f3da0bda46349c834cd412cab5f2_A_4 = _UV_d3b9edd36c37449ab8140ec76e38ea65_Out_0[3];
    float3 _DDY_47272e569af64d98a6d0fc20754cfef0_Out_1;
    Unity_DDY_float3(IN.WorldSpacePosition, _DDY_47272e569af64d98a6d0fc20754cfef0_Out_1);
    float3 _DDX_dcbff671d2ae4fb2b525d2bdf7a29bf7_Out_1;
    Unity_DDX_float3(IN.WorldSpacePosition, _DDX_dcbff671d2ae4fb2b525d2bdf7a29bf7_Out_1);
    float3 _CrossProduct_404f96107a8b4dda9e0bf2453a5d84cc_Out_2;
    Unity_CrossProduct_float(_DDY_47272e569af64d98a6d0fc20754cfef0_Out_1, _DDX_dcbff671d2ae4fb2b525d2bdf7a29bf7_Out_1, _CrossProduct_404f96107a8b4dda9e0bf2453a5d84cc_Out_2);
    float3 _Normalize_c2c75f9e5f724d8b9dc8afc0c960d9b2_Out_1;
    Unity_Normalize_float3(_CrossProduct_404f96107a8b4dda9e0bf2453a5d84cc_Out_2, _Normalize_c2c75f9e5f724d8b9dc8afc0c960d9b2_Out_1);
    surface.BaseColor = (IN.VertexColor.xyz);
    surface.Emission = float3(0, 0, 0);
    surface.Alpha = 1;
    surface.BentNormal = IN.TangentSpaceNormal;
    surface.Smoothness = _Split_c570f3da0bda46349c834cd412cab5f2_R_1;
    surface.Occlusion = 1;
    surface.NormalOS = _Normalize_c2c75f9e5f724d8b9dc8afc0c960d9b2_Out_1;
    surface.Metallic = _Split_c570f3da0bda46349c834cd412cab5f2_G_2;
    return surface;
}
...
void BuildSurfaceData(FragInputs fragInputs, inout SurfaceDescription surfaceDescription, float3 V, PositionInputs posInput, out SurfaceData surfaceData, out float3 bentNormalWS)
{
    ...
    surfaceData.metallic = surfaceDescription.Metallic;
        ...
        surfaceData.materialFeatures = MATERIALFEATUREFLAGS_LIT_STANDARD;
            ...
            // normal delivered to master node
            surfaceData.normalWS = TransformObjectToWorldNormal(surfaceDescription.NormalOS);
...
struct PackedVaryingsMeshToPS
{
    ...
    nointerpolation float4 interp6 : TEXCOORD6;
    nointerpolation float4 interp7 : TEXCOORD7;
    #if UNITY_ANY_INSTANCING_ENABLED
    uint instanceID : CUSTOM_INSTANCE_ID;
    #endif
};
